...
### 9. ストア公開ポリシー
- ストア公開の際は、詳細な手順を提示し、ユーザーの作業を極力サポートする。
- 公開にクローズテストや審査が必要な場合は、審査依頼提出完了でフェーズを終了し、その後にバグフィックス、機能の追加、UI改善の工程を入れること。
- テスターやレビューアからの改善提案が提出された場合は、それを考慮してバグフィックス、機能の追加、UI改善の工程を入れること。
- 審査完了の報告をユーザーから報告された場合は改善フェーズをクローズし、新しいフェーズで審査合格後の作業を計画し、行なうこと。
